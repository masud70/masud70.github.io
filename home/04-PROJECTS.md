...
[
  ...
  },
  {
    ...
    "date": "2023",
    "description": "A management system for RTC Barishal where the authentication layer uses a neural-network model for identity verification, integrated end-to-end with a standard web stack. Combines AI model deployment with production web infrastructure.",
