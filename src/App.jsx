		...
		<HashRouter>
			<div className="min-h-screen bg-ink-900 text-fog-200 font-sans antialiased relative">
				...
				>
					...
					<div
						className="absolute top-1/3 -right-40 w-[32rem] h-[32rem] rounded-full bg-em-500/5 blur-[120px] animate-floatSlow"
						style={{ animationDelay: "2s" }}
					/>
					<div
						className="absolute bottom-0 left-1/4 w-[28rem] h-[28rem] rounded-full bg-em-500/5 blur-[120px] animate-floatSlow"
